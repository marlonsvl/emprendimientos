    ...
    def _clean_row(self, row):
        ...
        try:
            cleaned = {
                ...
                'email': to_string(safe_get('email')),
                'propietario': to_string(safe_get('propietario')),
                'tipo_turismo': to_string(safe_get('tipo turismo')),
                'experiencia': to_int(safe_get('experiencia')),
                'asociacion': to_string(safe_get('asociacion')),
                'ruc': to_string(safe_get('ruc')) or 'No',
                'estado_local': to_string(safe_get('estado local')),
                'servicios_produccion': to_string(safe_get('servicios produccion')),
                'licencia_gad_loja': to_string(safe_get('licencia gad loja')),
                'arcsa': to_string(safe_get('arcsa')) or 'No',
                'turismo': to_string(safe_get('turismo')) or 'No',
                'equipos': to_string(safe_get('equipos')),
                'pagina_web': to_string(safe_get('pagina web')) or 'No',
                ...
                'tipo_servicio': to_string(safe_get('tipo servicio')),
                'precio_promedio': to_decimal(safe_get('precio promedio')),
                'procesos': to_string(safe_get('procesos')),
                'materia_prima': to_string(safe_get('materia prima')),
                'proveedores': to_string(safe_get('proveedores')),
                'numero_proveedores': to_int(safe_get('numero proveedores')),
                'numero_mujeres': to_int(safe_get('numero mujeres')),
                'numero_hombres': to_int(safe_get('numero hombres')),
                'tiempo_trabajando': to_int(safe_get('tiempo trabajando')),
                'personal_capacitado': to_string(safe_get('personal capacitado')) or 'No',
                'frecuencia_capacitacion': to_string(safe_get('frecuencia capacitacion')),
                'dependencia_ingresos': to_string(safe_get('dependencia ingresos')),
                'genero': to_string(safe_get('genero')),
                'nivel_educacion': to_string(safe_get('nivel educacion')) or 'No especificado',
